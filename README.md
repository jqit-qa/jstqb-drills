...
結果画面へ到達すると、受講者名・習得済み問題・前回の誤答・実施回数をブラウザの `localStorage` に保存します。同じ端末・ブラウザであれば、ページを閉じても前回の誤答から再開できます。複数端末間では同期しません。
...
50問構成、正答位置の分布、HTMLと問題バンク・解答表の整合、進捗の保存・復元・削除、受講者名変更時の制御、Slack通知の重複抑止を確認します。
